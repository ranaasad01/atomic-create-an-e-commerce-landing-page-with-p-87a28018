        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative grid grid-cols-2 gap-4">
              ...
              >
                <img
                  src="https://titoaistorageaccount.blob.core.windows.net/titoai-storage/87a28018-9657-46b5-a8d4-69bfcba3402a/images/uploaded-1782223454349-yo0d2p.png?v=1782223455325"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {reviews.map((review) => (
              ...
              >
                <div className="flex items-center gap-0.5" style={{ color: "#1160df", fontFamily: "Playfair Display", fontSize: "18px" }}>
                  {[1, 2, 3, 4, 5].map((s) => (
