        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative grid grid-cols-2 gap-4">
              ...
              >
                <img
                  src="https://titoaistorageaccount.blob.core.windows.net/titoai-storage/87a28018-9657-46b5-a8d4-69bfcba3402a/images/uploaded-1782222425862-ig618h.png?v=1782222426877"
